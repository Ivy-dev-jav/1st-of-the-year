var Fireworks = function(){
	...
	self.init = function(){	
		...
		// Lanzar fuegos artificiales automáticamente cada 3 segundos
	...
	// Función para lanzar 5 fuegos artificiales aleatorios
	self.launchFireworks = function(){
    for(var i = 0; i < 5; i++){
        self.currentHue = rand(self.hueMin, self.hueMax);
        self.fireworks.push(new Firework(
            rand(100, self.cw-100),  // <- Posición X aleatoria en la parte inferior
            self.ch, 
            rand(50, self.cw-50), 
            rand(50, self.ch/2)
        ));
